...
int main()
{
	...
	sjx::list<int>::reverse_iterator rit = l1.rbegin();
	...
	const sjx::list<int> l2(l1);
	sjx::list<int>::const_reverse_iterator rit2 = l2.rbegin();
	while (rit2 != l2.rend())
	{
		//++* rit2;
		std::cout << *rit2 << " ";
	...
	sjx::list<Date>::reverse_iterator rit3 = l3.rbegin();
	std::cout << rit3->_year << " " << rit3->_month << " " << rit3->_day << std::endl;
	return 0;
}
